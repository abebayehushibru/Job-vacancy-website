...
<div class="alert" >
  ...
  <img src="./assert/photos/right.png"> <span class="registerd">  Admin Successfuly Added!</span>
  
  
 
  </div>
  <div>
   <a href="addadmin.php"><button onclick="document.querySelector('.alert').style.display='none';">ok</button></a>
   </div>
  </div>
</div>
