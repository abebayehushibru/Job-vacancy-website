...
<body>
    ...
    <section class="sec_signin">
        <div class="container">
            <form action="" class="signin" method="post"  onclick="return false;">
                <h2>change password</h2>
                <?php
if(isset($_POST['change'])){
    include_once('changepasswodprocess.php');
}
?>

                <div>
                    <input type="password" name="phoneNumber" id="" placeholder="password" class="phonenumber" required>
                    <span></span>
                </div>
                <div>
                    <input type="password" placeholder="confrim password " class="phonenumber"name="confrimpassword" id="" required>
                    <span></span>
                </div>
           <div> <button class="submit" name="change">change</button></div>
