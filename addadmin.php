...
if(isset($_POST['addadmin'])){
    ...
    include_once('addadminprocess.php');
}
?>
                <div>
                    <input type="TEL" name="phoneNumber" id="" placeholder="phone number" class="phonenumber" required>
                    <span></span>
                </div>
                <div>
                    <input type="email" placeholder="email " class="phonenumber"name="email" required>
                    <span></span>
                </div>
                <div>
                    <input type="password" placeholder="password " class="phonenumber"name="password" required>
                    <span></span>
                </div>
                <div>
                    <input type="password" placeholder="confirm password " class="phonenumber"name="cmpassword" required>
                    <span></span>
                </div>
                
           <div> <button class="submit" name="addadmin"> ADD </button></div>
